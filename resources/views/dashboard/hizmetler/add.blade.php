                                        ...
                                        @foreach ($categories as $category)
                                            @isset($data)
                                                @if ($data->category_id == $category->id)
                                                    <option value="{{ $category->id }}" selected>{{ $category->category_details[0]->title }}</option>
                                                @else
                                                    <option value="{{ $category->id }}">{{ $category->category_details[0]->title }}</option>
                                                @endif
                                            @else
                                                <option value="{{ $category->id }}">{{ $category->category_details[0]->title }}</option>
                                            @endisset
                                            ...
                                            <ul class="nav nav-tabs nav-danger" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link active" data-bs-toggle="tab" href="#danger1"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="tab-icon"><ion-icon name="home-sharp"
                                                                    class="me-1 md hydrated" role="img"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#danger2" role="tab"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="tab-icon"><ion-icon name="person-sharp"
                                                                    class="me-1 md hydrated" role="img"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link" data-bs-toggle="tab" href="#danger3"
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="tab-icon"><ion-icon name="call-sharp"
                                                                    class="me-1 md hydrated" role="img"
                                                                    aria-label="call sharp"></ion-icon>
                                                            </div>
